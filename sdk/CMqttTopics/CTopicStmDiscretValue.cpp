#include "CTopicStmDiscretValue.h"
 ...
 * @brief Конструктор
 ** ***********************************************************************/
CTopicStmDiscretValue::CTopicStmDiscretValue(const int value, const QByteArray & json ) :
 ...
 * @return bool
 ** ***********************************************************************/
bool CTopicStmDiscretValue::initFromData(const CTopicValueEntry & value)
{
    bool res{ false };
...
* @return QByteArray
** ***********************************************************************/
QByteArray CTopicStmDiscretValue::prepareData() const
{
